            ...
            >
              ...
              <details className="font-bold">
                ...
                <ul className="p-2">
                  ...
                  <li>
                    <button
                      onClick={() => router.push("/products/analgesicos")}
                      className="btn btn-ghost p-0"
                    >
                      Analgesicos
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => router.push("/products/suplementos")}
                      className="btn btn-ghost p-0"
                    >
                      Suplementos
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => router.push("/products/higiene")}
                      className="btn btn-ghost p-0"
                    >
                      Higiene
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => router.push("/products/anticonceptivos")}
                      className="btn btn-ghost p-0"
                    >
                      anticonceptivos
                    </button>
